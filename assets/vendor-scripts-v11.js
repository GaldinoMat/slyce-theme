      ...
      (function (e) {
        ...
        function i(t, e, i) {
          ...
          return (
            ...
            n(i) &&
              ((w = !!i.leading),
              (p = (S = "maxWait" in i) ? y(o(i.maxWait) || 0, e) : p),
        ...
        function o(t) {
          ...
          t = t.replace(c, "");
          var i = d.test(t);
          return i || h.test(t) ? p(t.slice(2), i ? 2 : 8) : u.test(t) ? a : +t;
        }
        var r =
        ...
        t.exports = function (t, e, o) {
          ...
          return (
            ...
            i(t, e, { leading: r, maxWait: e, trailing: a })
          );
        };
      }).call(
        e,
    ...
    function (t, e) {
      (function (e) {
        ...
        function n(t) {
          ...
          t = t.replace(a, "");
          var n = c.test(t);
          return n || u.test(t) ? d(t.slice(2), n ? 2 : 8) : l.test(t) ? r : +t;
        }
        var o =
            "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
              ? function (t) {
        ...
        t.exports = function (t, e, o) {
          ...
          function s(t) {
            var i = t - m;
            return void 0 === m || i >= e || i < 0 || (w && t - b >= h);
          }
          function a() {
            var t = y();
            return s(t)
              ...
              : void (f = setTimeout(
                  ...
                  (function (t) {
                    var i = e - (t - m);
                    return w ? v(i, h - (t - b)) : i;
                  })(t)
                ));
          }
          function l(t) {
            return (f = void 0), S && u ? r(t) : ((u = d = void 0), p);
          }
          function c() {
            var t = y(),
              i = s(t);
            if (((u = arguments), (d = this), (m = t), i)) {
              if (void 0 === f)
                return (function (t) {
                  return (b = t), (f = setTimeout(a, e)), x ? r(t) : p;
                })(m);
              if (w) return (f = setTimeout(a, e)), r(m);
            }
          ...
          return (
            ...
            i(o) &&
              ((x = !!o.leading),
              (h = (w = "maxWait" in o) ? g(n(o.maxWait) || 0, e) : h),
    ...
    var i = {
      ...
      setTranslateX: function (t, e) {
        ...
        if (
          ...
          this.slider.parentElement.parentElement.parentElement.classList.contains(
            "product__main-photos"
          )
        ) {
          const t = Number(i.split("%")[0]);
          n = (t + 0 * t).toString() + "%";
        } else n = i;
    ...
    (o.updateSlides = function () {
      ...
      (o.onSettleFade = function () {
        delete this.didDragEnd,
          this.options.fade && this.slides[this.fadeIndex];
      }),
                  ...
                  var i = l.w / e.w,
                    ...
                    c = function (e) {
                      1 === e
                        ...
                        It(),
                        h ? (t.style.opacity = 1 - e) : Pt(a - e * a);
                    };
                  d
                    ? Kt("initialZoom", 0, 1, p, o.easing.cubic.out, c, f)
  ...
  (function (t, e) {
    ...
    function B(e, i, n) {
            ...
            o.addEventListener("keydown", function (t) {
              return (function (t, e) {
                ...
                if ((t.preventDefault(), h || d)) {
                  ...
                  if (null === g) return !1;
                  !1 === g &&
                    (g = C.getDefaultStep(k[e], d, i.keyboardDefaultStep)),
                    (u || c) && (g *= f),
                    (g = Math.max(g, 1e-7)),
                    (g *= d ? -1 : 1),
                    (a = D[e] + g);
      ...
      function W() {
        j(),
          (v = d.map(N)),
          et("update" + w.tooltips, function (t, e, n) {
      ...
      function X(t) {
        ...
        return (g = E.appendChild(B(e, i, n)));
      }
      function Y() {
      ...
      function G(t, e, n, o) {
        ...
        return (
          t.split(" ").forEach(function (t) {
            e.addEventListener(t, r, !!S && { passive: !0 }), s.push([t, r]);
          }),
          s
        );
      }
        ...
        if (!e.handleNumbers.some(R)) {
          ...
          o.push.apply(o, r.concat(a, l)),
            t.cursor &&
              ...
              d.length > 1 && h(E, i.cssClasses.drag),
        ...
        (n = n.slice()),
          ...
          n.length > 1
            ? n.forEach(function (t, i) {
                var n = ot(r, t, r[t] + e, a[i], l[i], !1);
                !1 === n ? (e = 0) : ((e = n - r[t]), (r[t] = n));
              })
            : (a = l = [!0]);
        var c = !1;
        n.forEach(function (t, n) {
          c = ct(t, i[t] + e, a[n], l[n]) || c;
        }),
          c &&
        ...
        return (
          ...
          !1 !== e &&
            ((function (t, e) {
              ...
              var n = "translate(" + rt(10 * (at(e, 0) - z) + "%", "0") + ")";
              (d[t].style[i.transformRule] = n), ut(t), ut(t + 1);
            })(t, e),
            !0)
        );
      }
      ...
      function ht(t, e, n) {
        ...
        lt(),
          P.forEach(function (t) {
            nt("update", t), null !== o[t] && e && nt("set", t);
          });
      }
      function pt(t) {
        if ((void 0 === t && (t = !1), t))
      ...
      h((y = E), i.cssClasses.target),
        ...
        i.tooltips && W(),
        it("update" + w.aria),
        et("update" + w.aria, function (t, e, n, o, r) {
          P.forEach(function (t) {
            var e = d[t],
              o = ot(k, t, 0, !0, !0, !0),
              s = ot(k, t, 100, !0, !0, !0),
    ...
    var X = { __spectrum: y, cssClasses: x, create: Z };
    (t.create = Z),
      (t.cssClasses = x),
      (t.default = X),
